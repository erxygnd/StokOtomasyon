...
public class UrunEkle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(105, 105, 105)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(add, javax.swing.GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(name)
                        .addComponent(type)
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
    	...
    	String str2=String.valueOf(price.getText());
    	String str3=String.valueOf(type.getText());
    	Product pd=new Product(str,str2,str3);
    	DatabaseCon databaseCon=new DatabaseCon().getSqlFrontController();
    	databaseCon.product=pd;
    	databaseCon.command("addproduct");
